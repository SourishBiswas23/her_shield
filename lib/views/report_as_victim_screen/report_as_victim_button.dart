...
import 'package:hackathon_project/controllers/report_bloc/report_bloc.dart';
...
class ReportAsVictimButton extends StatelessWidget {
  const ReportAsVictimButton({
    super.key,
    ...
    return GestureDetector(
      onTap: () async {
        if (_formKey.currentState!.validate()) {
          ...
          final reportAsVictimModel = ReportAsVictimModel(
            userId: userId,
          ...
          reportBloc.add(ReportAsVictimEvent(
            ReportAsVictimModel: reportAsVictimModel,
          ));
        }
      },
      child: Container(
