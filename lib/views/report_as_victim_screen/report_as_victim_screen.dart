...
import "report_as_victim_button.dart";

class ReportAsVictimScreen extends StatefulWidget {
  const ReportAsVictimScreen({super.key});

  @override
  State<ReportAsVictimScreen> createState() => _ReportAsVictimScreenState();
}

class _ReportAsVictimScreenState extends State<ReportAsVictimScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                ReportAsVictimButton(
                  ...
                  organisationStateController: _organisationStateController,
